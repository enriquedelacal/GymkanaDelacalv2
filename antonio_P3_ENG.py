...
def ex4_ant(resuelto):
    ...
    print('Consider column ' + column + ' of a chessboard as fixed. If variable "row" ', end='', flush=True)
    print('(without quotes) contains the row number, replace the ellipsis in the following ', end='', flush=True)
