...
def ex1_ant(resuelto):
    ...
    print('¿Qué se muestra por pantalla tras ejecutar el siguiente trozo de código?')
    ...
    while not (check_int(line) or line=='exit'):
        print('\nDebes escribir un entero positivo.')
        print('¿Qué se muestra por pantalla tras ejecutar el siguiente trozo de código?')
        print('(Escribe "exit" (sin comillas) para salir del programa)')
        print('>>> ' + sign + str(actualParam[1]) + '**' + str(actualParam[2]) + '**' + str(actualParam[3]))
        line = input()
...
def ex2_ant(resuelto):
    ...
    print('¿Cuál es el resultado de ejecutar la siguiente línea de código?')
    print('Usa este formato: [a, b, c, d, ...]')
    print('(Escribe "exit" (sin comillas) para salir del programa)')
    ...
    while not (correct or line=='exit'):
        print('\nDebes escribir una lista de enteros: [a, b, c, d, ...]')
        print('¿Cuál es el resultado de ejecutar la siguiente línea de código?')
        print('(Escribe "exit" (sin comillas) para salir del programa)')
        print('>>> range(' + str(param[0]) + ', ' + str(param[1]) + ', ' + str(param[2]) + ')')
        line = input()
...
def ex3_ant(resuelto):
    ...
    print('Escribe un indentificador válido de Python que incluya, al menos:')
    print(' - Un número')
    print(' - Una letra')
    print(' - Un carácter no alfa-numérico')
    print('(Escribe "exit" (sin comillas) para salir del programa)')
    identifier = input('')
...
def ex4_ant(resuelto):
    ...
    print('Considera fijada la columna ' + column + ' de un tablero de ajedrez. Si la variable ', end='', flush=True)
    print('"row" (sin comillas) contiene el número de fila, reemplaza los puntos suspensivos ', end='', flush=True)
    print('en la siguiente línea de código que asigna a la variable isWhite si la casilla es blanca o no:')
    print('>>> isWhite = ...')
    print('\n¡Ten cuidado de llamar a la variable exactamente "row" (sin comillas)!')
    print('(Escribe "exit" (sin comillas) para salir del programa)')
    line = input('isWhite = ')
