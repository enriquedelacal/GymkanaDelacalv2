...
def gcm_ex1(solved):
    ...
    msg = """¿Cuál es el resultado de la siguiente expresión?
(Escribe "exit" (sin comillas) para salir del programa)
>>> {0}
""".format(expression)
...
def gcm_ex2(solved):
    ...
    msg = """Indica un valor entero válido que debería tener la variable 'a' para que el siguiente fragmento de código muestre 'Opción 2' por pantalla tras su ejecución.
(Escribe "exit" (sin comillas) para salir del programa)
...
def gcm_ex3(solved):
    ...
    msg = """Indica qué valor escribiría por pantalla la ejecución del siguiente código. Por ejemplo, si ejecutase print(15), tu respuesta deberá ser "15" (sin comillas).
(Escribe "exit" (sin comillas) para salir del programa)
...
def gcm_ex4(solved):
    ...
    msg = """Indica el valor que tendrá la variable 'counter' al final de la ejecución de este programa.
(Escribe "exit" (sin comillas) para salir del programa)
...
def gcm_ex6(solved):
    ...
    msg = """Indica el valor que tendrá la variable 'n' al final de la ejecución de este programa.
(Escribe "exit" (sin comillas) para salir del programa)
